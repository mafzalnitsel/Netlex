...
module.exports = function (app) {
    ...
    app.get("/businessAgreementsListByStatus/:value",BusinessAgreement.businessAgreementsListByStatus);

    app.get("/businessAgreementById/:id", BusinessAgreement.businessAgreementById);
   ...
   // app.get('/getLawyersWithAvailability', Lawyer.getLawyersWithAvailability);
    ...
    app.get('/getclientsDetailstoSsn/:toSsn', clientsDetails.getclientsDetailstoSsn);
 
    app.get('/getclientsDetailstossnto/:toSsn', clientsDetails.getclientsDetailstossnto);
 
    app.get('/getclientsDetailstoEmail/:toEmail', clientsDetails.getclientsDetailstoEmail);
    app.get('/getclientsDetailstoPhoneNumber/:toPhoneNumber', clientsDetails.getclientsDetailstoPhoneNumber);
    ...
    app.get("/getActiveshowLawyerToUserList", Lawyer.getActiveshowLawyerToUserList);
