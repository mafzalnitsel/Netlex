module.exports = {
    ...
    KLARNA_PAYMENT_URL: process.env.KLARNA_PAYMENT_URL || 'https://api.klarna.com',
   ...
   // KLARNA_USERNAME: process.env.KLARNA_USERNAME || '52410_82d78c5eca89',
    ...
    //========================== For TEST =========================
    BANK_ID_AUTH_BY_IDKOLLEN: process.env.BANK_ID_AUTH_BY_IDKOLLEN || 'https://stgapi.idkollen.se/v2/069c8741-bfe1-11ec-af31-067d45a106d8/auth',
    BANK_ID_COLLECT_BY_IDKOLLEN: process.env.BANK_ID_COLLECT_BY_IDKOLLEN || 'https://stgapi.idkollen.se/v2/069c8741-bfe1-11ec-af31-067d45a106d8/collect/', 
    ...
    BANK_ID_FPT_CERTIFICATE: process.env.BANK_ID_FPT_CERTIFICATE || './certificate/FPTestcert4_20220818.p12',
    ...
    SWISH_SALE_CALLBACK_URL: process.env.SWISH_SALE_CALLBACK_URL || 'https://netlex.se/swishsale/success', 
    SWISH_CALLBACK_URL: process.env.SWISH_CALLBACK_URL || 'https://netlex.se/swish/success',
    ...
    //Live Redirect /*11-02-2023Nadeem*/
    STRIPE_SUCCESS_URL: process.env.STRIPE_SUCCESS_URL || 'https://netlex.se/stripe/success',
    STRIPE_SALE_SUCCESS_URL: process.env.STRIPE_SALE_SUCCESS_URL || 'https://netlex.se/stripesale/success',
    STRIPE_CANCEL_URL: process.env.STRIPE_CANCEL_URL || 'https://netlex.se/stripe/cancel',
    ...
    OAUTH_REDIRECT_URI: process.env.OAUTH_REDIRECT_URI || 'https://api.netlex.se/auth/callback',
