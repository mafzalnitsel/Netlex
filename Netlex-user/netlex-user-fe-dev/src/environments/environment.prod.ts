export const environment = {
  ...
  // serviceURL: 'userApi/',
  // baseUrl: '',
  // contactToBookLawyerUrl: 'http://ec2-54-93-32-54.eu-central-1.compute.amazonaws.com/userPortal/scheduler',
  // accountSettingUrl: 'http://ec2-54-93-32-54.eu-central-1.compute.amazonaws.com/userPortal/accountSettings'
  //server.netlex.se
