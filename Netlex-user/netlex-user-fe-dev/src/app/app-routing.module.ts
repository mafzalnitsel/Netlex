...
const routes: Routes = [
  ...
  {
    path: "business-agreement-confirm/:_id",
    component: BusinessAgreementConfirmComponent,
  },
  ...
  {
    path: "questionAndAnswer/6525116525",
    component: QuestionAndAnswer1Component,
  },
  ...
  {
    path: "Kommersnartprivatperson",
    component: KommersnartPrivatePerrsonComponent,
  },
