...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.innerWidth <= 960) {
      ...
      localStorage.setItem("userDevice", "Windows");
    }

    // console.log("document.documentElement.scrollTop", document.documentElement.scrollTop);
    let isBackFromActivityAreas = localStorage.getItem("returnFrom");
    if (isBackFromActivityAreas && isBackFromActivityAreas == "activityAreas") {
      // console.log('returnFromActivityAreas');
      ...
      //   console.log('1');
      //   window.scroll(0, 900);
      // } else if (windowWidth > 1000 && windowWidth < 2500) {
      //   console.log('2');
      //   window.scroll(0, 720);
      // }
      ...
      //   window.scroll(0, 1600);
      // }
      // else if (windowWidth > 350 && windowWidth < 501) {
      //   console.log('5',document.getElementById('#targetRed'));
      //   console.log('eleRef',this.eleRef.nativeElement.getElementsByClassName('imageServices'));
      //   console.log('this.scroller',this.scroller.scrollToAnchor('targetRed'));
      //   this.scroller.scrollToAnchor("targetGreen");
      //   // let dddd = this.eleRef.nativeElement.getElementsByClassName('imageServices');
      //   // this.eleRef.nativeElement.getElementsByClassName('imageServices').scrollIntoView();
      //   // console.log('eleRef',this.eleRef.nativeElement.getElementsByClassName('services-dark-img').length);
      //   // window.scroll(0, 985);
  ...
  getContentPages(): any {
    ...
    this.ContentpagesService.getContentPages(Pagename).subscribe(
      (contentpage) => {
        ...
        // localStorage.setItem('userDevice',contentpage.device)
        ...
        this.services_bg_image =
          environment.adminserviceURL + this.home.servicesBgImage;
        ...
        this.homeHeaderPic =
          environment.adminserviceURL + this.home.homeHeaderPic;
        this.homeHeaderPicMob =
          environment.adminserviceURL + this.home.homeHeaderPicMob;
        this.selectAgreementImg =
          environment.adminserviceURL + this.home.selectAgreementImg;

        this.fillAgreementImg =
          environment.adminserviceURL + this.home.fillAgreementImg;

        this.purchaseImg = environment.adminserviceURL + this.home.purchaseImg;

        this.availabilityImg =
          environment.adminserviceURL + this.home.availabilityImg;
  ...
  serviceClickHandler(name: string) {
    // console.log("name", name);

    // console.log('document.documentElement.scrollTop', document.documentElement.scrollTop);
    // localStorage.setItem('scrl', document.documentElement.scrollTop.toString())
  ...
  agreementOpenHandlerPrivatePerson(value) {
