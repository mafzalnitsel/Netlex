...
export class LawyersInHomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //         // console.log("this.stopAutoScroll", this.stopAutoScroll)
    //         // console.log("this.stopAutoScroll2",this.stopAutoScroll2)
    ...
    //           // console.log("document.getElementById('scrollLawyersDiv')",document.getElementById('scrollLawyersDiv'))
    //           if(document.getElementById('scrollLawyersDiv') !== null){
    ...
    //       // let lawyerScrollPosition = document.getElementById('scrollLawyersDiv').scrollLeft;
    //       if (this.lawyerScrollPosition !== 3000) {
    //         // this.lawyerScrollPosition = this.lawyerScrollPosition + 1;
    //         this.lawyerScrollPosition = this.lawyerScrollPosition + 1
    //         document.getElementById('scrollLawyersDiv').scrollTo(this.lawyerScrollPosition, 0)
    //         // this.scrollPointNumber = this.scrollPointNumber + 1;
  ...
  scheduleMeetingRedirect(lawyer) {
    ...
    this.stopAutoScroll2 = false;
  }
  redirect(lawyerdetail) {
    // console.log("lawyerdetail",lawyerdetail)
    
    //Commented (09-12-2022)
