...
@Component({
  selector: 'app-aboutus-similar',
  templateUrl: './aboutus-similar.component.html',
  styleUrls: ['./aboutus-similar.component.scss']
})
export class AboutusSimilarComponent implements OnInit {
 ...
 showimage:any;
  ...
  aHeading:any; 
  LawyerDetail :Array<{activityArea: string,
  ...
  LawyerDetailtwo :Array<{activityArea: string,
    email: string,firstName: string,
    languages: string,lastName: string,
    lawyerPic: string,
    phoneNumber: string,showLawyerToUser: string,
  ...
  LawyerDetailthree :Array<{activityArea: string,
    email: string,firstName: string,
    languages: string,lastName: string,
    lawyerPic: string,
    phoneNumber: string,showLawyerToUser: string,
  ...
  LawyerDetailfoure :Array<{activityArea: string,
    email: string,firstName: string,
    languages: string,lastName: string,
    lawyerPic: string,
    phoneNumber: string,showLawyerToUser: string,
  ...
  AllLawyerDetail :Array<{activityArea: string,
    email: string,firstName: string,
    languages: string,lastName: string,
    lawyerPic: string,
    phoneNumber: string,showLawyerToUser: string,
