...
@Component({
    selector: 'app-user-input3',
    templateUrl: './user-input3.component.html',
    styleUrls: ['./user-input3.component.scss']
})
export class UserInput3Component implements OnInit {
    //----||---New---||----//
    ...
    videos = [{ id: 'video1', path: 'assets/videos/video1.mp4', value: false }]
    videosExists = true;
