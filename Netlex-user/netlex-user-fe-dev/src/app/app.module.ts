...
import {AppTranslateLoader, initTranslation} from './services/app-translate-loader';
...
import { HomeOldComponent, SafeHtmlPipe } from './screens/home-old/home-old.component';
...
@NgModule({
    ...
    providers: [
        ...
        AnswerOptionService,
        AnswerTypeService,
        PaymentService,SaleService,contentpagesService,clientsDetailsservice,
        UtilService,
        {
