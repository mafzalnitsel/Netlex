...
@Component({
  ...
  templateUrl: './view-lawyer-scheduler.component.html',
  styleUrls: ['./view-lawyer-scheduler.component.scss']
})
export class ViewLawyerSchedulerComponent implements OnInit {
  lawyerGet: Lawyer[];
    ...
    this.api.getMeetData(this.id)
      .subscribe(
        res => {
          ...
          console.log("res.focnonfoc;----",res.focnonfoc)
  ...
  update(): void {
    ...
    console.log("this.data-lawyer----",this.data)
