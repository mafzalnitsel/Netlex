...
export class PrivacyAndPolicyComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getPrivacyAndPolicyData('privacyAndPolicy');


  }
  getPrivacyAndPolicyData(name): any {

    this.api.getPrivacyAndPolicy(name).subscribe(data => {
  ...
  updatePrivacyAndPolicy(): any {
    this.showloading = true;
    this.contentPages = [{
      'paragraphs': this.paragraphs,
    }]
    // console.log("contentPages", this.contentPages)
    this.api.updatePrivacyAndPolicy(this.contentPages, this.id)
      .subscribe(
        res => {
