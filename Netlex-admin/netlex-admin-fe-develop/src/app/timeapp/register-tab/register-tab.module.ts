...
import { CounterPartiesComponent } from './counter-parties/counter-parties.component';
import { CoPartnersComponent } from './co-partners/co-partners.component';
...
@NgModule({
  ...
  exports: [RegisterTabComponent]
})
export class RegisterTabModule { }
